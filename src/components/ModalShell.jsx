export default function ModalShell({ children, title, onClose }) {
  return (
    <div
      ...
      style={{ position: 'fixed', inset: 0, background: 'rgba(26,22,20,0.55)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 999, padding: 'max(16px, env(safe-area-inset-top, 16px)) 12px max(16px, env(safe-area-inset-bottom, 16px))' }}>
      <div style={{ background: 'var(--bg-modal)', border: '1px solid var(--border)', width: '100%', maxWidth: 600, maxHeight: '92vh', overflow: 'auto', borderRadius: 12, boxShadow: 'var(--shadow-modal)' }}>
